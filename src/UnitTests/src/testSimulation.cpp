...
TYPED_TEST(SimulationTest, Can_create_Simulation_with_Grid_Base_and_FDTD_Base)
{
    ...
    Grid_Base *grid = new YeeGrid_Base(gridSize, timeStep, minCoords, steps, gridSize);
    Module *fdtd = new FDTD_Module(grid);
