...
namespace pfc
{
    ...
    public:
        ...
        void setFieldConfiguration(const FieldConfigurationType* fieldConf) {
            ...
            TGrid* grid = derived->getFieldEntity()->getGrid();
            TFieldSolver* fieldSolver = derived->getFieldEntity()->getFieldSolver();
...
OMP_SIMD()
    ...
    public:
        ...
        FP3 getE(const FP3& coords) const {
            return static_cast<const TDerived*>(this)->getFieldEntity()->getGrid()->getE(coords);
        }

        FP3 getB(const FP3& coords) const {
            return static_cast<const TDerived*>(this)->getFieldEntity()->getGrid()->getB(coords);
        }

        FP3 getJ(const FP3& coords) const {
            return static_cast<const TDerived*>(this)->getFieldEntity()->getGrid()->getJ(coords);
        }

        void getFields(const FP3& coords, FP3& e, FP3& b) const {
            static_cast<const TDerived*>(this)->getFieldEntity()->getGrid()->getFields(coords, e, b);
        }
    };
    ...
    public:
        ...
        void setExyz(int64_t fEx, int64_t fEy, int64_t fEz) {
            ...
            static_cast<const TDerived*>(this)->getFieldEntity()->getAnalyticalField()->setE(fx, fy, fz);
        }
        ...
        void setBxyz(int64_t fBx, int64_t fBy, int64_t fBz) {
            ...
            static_cast<const TDerived*>(this)->getFieldEntity()->getAnalyticalField()->setB(fx, fy, fz);
        }
        ...
        void setJxyz(int64_t fJx, int64_t fJy, int64_t fJz) {
            ...
            static_cast<const TDerived*>(this)->getFieldEntity()->getAnalyticalField()->setJ(fx, fy, fz);
        }

        FP3 getE(const FP3& coords) const {
            return static_cast<const TDerived*>(this)->getFieldEntity()->getAnalyticalField()->getE(coords);
        }

        FP3 getB(const FP3& coords) const {
            return static_cast<const TDerived*>(this)->getFieldEntity()->getAnalyticalField()->getB(coords);
        }

        FP3 getJ(const FP3& coords) const {
            return static_cast<const TDerived*>(this)->getFieldEntity()->getAnalyticalField()->getJ(coords);
        }

        FP3 getEt(FP x, FP y, FP z, FP t) const {
            return static_cast<const TDerived*>(this)->getFieldEntity()->getAnalyticalField()->getE(x, y, z, t);
        }

        FP3 getBt(FP x, FP y, FP z, FP t) const {
            return static_cast<const TDerived*>(this)->getFieldEntity()->getAnalyticalField()->getB(x, y, z, t);
        }

        FP3 getJt(FP x, FP y, FP z, FP t) const {
            return static_cast<const TDerived*>(this)->getFieldEntity()->getAnalyticalField()->getJ(x, y, z, t);
        }
    };
    ...
    public:
        void convertFieldsPoissonEquation() {
            static_cast<TDerived*>(this)->getFieldEntity()->getFieldSolver()->convertFieldsPoissonEquation();
        }
    };
    ...
    public:
        void setPeriodicalFieldGenerator() {
            ...
            static_cast<TDerived*>(this)->getFieldEntity()->getFieldSolver()->setFieldGenerator(&gen);
        }
    ...
    public:
        void setPML(int sizePMLx, int sizePMLy, int sizePMLz) {
            static_cast<TDerived*>(this)->getFieldEntity()->getFieldSolver()->setPML(sizePMLx, sizePMLy, sizePMLz);
        }
    };
    ...
    public:
        ...
        void setTime(FP time) {
            static_cast<TDerived*>(this)->getFieldEntity()->getFieldSolver()->globalTime = time;
        }

        FP getTime() {
            return static_cast<TDerived*>(this)->getFieldEntity()->getFieldSolver()->globalTime;
        }

        void changeTimeStep(double dt) {
            static_cast<TDerived*>(this)->getFieldEntity()->getFieldSolver()->setTimeStep(dt);
        }

        void updateFields() {
            static_cast<TDerived*>(this)->getFieldEntity()->getFieldSolver()->updateFields();
        }

        void advance(FP dt) {
            auto fieldSolver = static_cast<TDerived*>(this)->getFieldEntity()->getFieldSolver();
    ...
    public:
        ...
        pyField(const Int3 & numInternalCells,
            ...
            fieldEntity(new FieldEntity<TGrid, TFieldSolver>(numInternalCells,
                minCoords, steps, dt))
        {}

        pyField(FP dt) :
            fieldEntity(new FieldEntity<TGrid, TFieldSolver>(dt))
        {}
        ...
        inline FieldEntity<TGrid, TFieldSolver>* getFieldEntity() const {
        ...
        inline FP3 convertCoords(const FP3& coords, FP timeShift = 0.0) const {
            bool status = true;
            return getDirectCoords(coords, getFieldEntity()->getFieldSolver()->globalTime + timeShift, &status);
        }
        ...
        inline FP3 getE(const FP3& coords) const override {
            bool status = true;
            FP time = getFieldEntity()->getFieldSolver()->globalTime + getFieldEntity()->getFieldSolver()->timeShiftE;
        ...
        inline FP3 getB(const FP3& coords) const override {
            bool status = true;
            FP time = getFieldEntity()->getFieldSolver()->globalTime + getFieldEntity()->getFieldSolver()->timeShiftB;
            FP3 inverseCoords = getInverseCoords(coords, time, &status);
            if (!status) return FP3(0, 0, 0);
        ...
        FP3 getJ(const FP3& coords) const override {
            bool status = true;
            FP time = getFieldEntity()->getFieldSolver()->globalTime + getFieldEntity()->getFieldSolver()->timeShiftJ;
            FP3 inverseCoords = getInverseCoords(coords, time, &status);
            if (!status) return FP3(0, 0, 0);
    ...
    private:
        ...
        std::unique_ptr<FieldEntity<TGrid, TFieldSolver>> fieldEntity;
    ...
    pyAnalyticalField::pyField(FP dt) :
        fieldEntity(new FieldEntity<NoGrid, NoFieldSolver>(dt)) {}
